...
{
    [Serializable]
    [CreateAssetMenu(menuName = MenuConst.GFZX01_CarData + "Car Data")]
    public class CarDataSobj : ScriptableObject, IBinarySerializable, IFile
    {
        public const int MachineCount = GameCube.GFZX01.CarData.CarData.MachineCount;
        public const int BodyCount = GameCube.GFZX01.CarData.CarData.BodyCount;
        public const int CockpitCount = GameCube.GFZX01.CarData.CarData.CockpitCount;
        public const int BoosterCount = GameCube.GFZX01.CarData.CarData.BoosterCount;
        public const int kPaddingSize = GameCube.GFZX01.CarData.CarData.kPaddingSize;
        public const bool kBigEndian = GameCube.GFZX01.CarData.CarData.kBigEndian;
        public const bool kLittleEndian = GameCube.GFZX01.CarData.CarData.kLittleEndian;
        public const int kMachineNameTable = GameCube.GFZX01.CarData.CarData.kMachineNameTable;
        public const int kUnknownTable = GameCube.GFZX01.CarData.CarData.kUnknownTable;
