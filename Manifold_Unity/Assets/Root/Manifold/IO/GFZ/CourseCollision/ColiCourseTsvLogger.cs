    ...
    public static class ColiCourseTsvLogger
    {
        ...
        public static void AnalyzeTrackNodes(ColiScene[] scenes, string fileName)
        {
            using (var writer = AnalyzerUtility.OpenWriter(fileName))
            {
                ...
                writer.WriteNextColNicify(nameof(TrackCheckpoint.planeStart.dotProduct));
                writer.WriteNextColNicify(nameof(TrackCheckpoint.planeStart.direction) + ".x");
                writer.WriteNextColNicify(nameof(TrackCheckpoint.planeStart.direction) + ".y");
                writer.WriteNextColNicify(nameof(TrackCheckpoint.planeStart.direction) + ".z");
                writer.WriteNextColNicify(nameof(TrackCheckpoint.planeStart.position) + ".x");
                writer.WriteNextColNicify(nameof(TrackCheckpoint.planeStart.position) + ".y");
                writer.WriteNextColNicify(nameof(TrackCheckpoint.planeStart.position) + ".z");
                writer.WriteNextColNicify(nameof(TrackCheckpoint.planeEnd.dotProduct));
                writer.WriteNextColNicify(nameof(TrackCheckpoint.planeEnd.direction) + ".x");
                writer.WriteNextColNicify(nameof(TrackCheckpoint.planeEnd.direction) + ".y");
                writer.WriteNextColNicify(nameof(TrackCheckpoint.planeEnd.direction) + ".z");
                writer.WriteNextColNicify(nameof(TrackCheckpoint.planeEnd.position) + ".x");
                writer.WriteNextColNicify(nameof(TrackCheckpoint.planeEnd.position) + ".y");
                writer.WriteNextColNicify(nameof(TrackCheckpoint.planeEnd.position) + ".z");
                writer.WriteNextColNicify(nameof(TrackCheckpoint.endDistance));
                writer.WriteNextColNicify(nameof(TrackCheckpoint.startDistance));
                writer.WriteNextColNicify(nameof(TrackCheckpoint.trackWidth));
                writer.WriteNextColNicify(nameof(TrackCheckpoint.connectToTrackIn));
                writer.WriteNextColNicify(nameof(TrackCheckpoint.connectToTrackOut));
