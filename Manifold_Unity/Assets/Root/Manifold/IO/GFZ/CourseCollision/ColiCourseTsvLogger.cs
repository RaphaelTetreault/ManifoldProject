    ...
    public static class ColiCourseTsvLogger
    {
        ...
        public static void AnalyzeTrackNodes(ColiScene[] scenes, string fileName)
        {
            using (var writer = AnalyzerUtility.OpenWriter(fileName))
            {
                ...
                writer.WriteNextColNicify(nameof(TrackCheckpoint.start.tangent) + ".x");
                writer.WriteNextColNicify(nameof(TrackCheckpoint.start.tangent) + ".y");
                writer.WriteNextColNicify(nameof(TrackCheckpoint.start.tangent) + ".z");
                ...
                writer.WriteNextColNicify(nameof(TrackCheckpoint.end.tangent) + ".x");
                writer.WriteNextColNicify(nameof(TrackCheckpoint.end.tangent) + ".y");
                writer.WriteNextColNicify(nameof(TrackCheckpoint.end.tangent) + ".z");
                ...
                foreach (var scene in scenes)
                {
                    ...
                    foreach (var trackNode in scene.trackNodes)
                    {
                        ...
                        foreach (var trackPoint in trackNode.checkpoints)
                        {
                            ...
                            writer.WriteNextCol(trackPoint.start.tangent.x);
                            writer.WriteNextCol(trackPoint.start.tangent.y);
                            writer.WriteNextCol(trackPoint.start.tangent.z);
                            ...
                            writer.WriteNextCol(trackPoint.end.tangent.x);
                            writer.WriteNextCol(trackPoint.end.tangent.y);
                            writer.WriteNextCol(trackPoint.end.tangent.z);
