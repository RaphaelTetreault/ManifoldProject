        ...
        IAnalyzable
    {
        ...
        public void AnalyzeHeaders(string fileName)
        {
            using (var writer = AnalyzerUtility.OpenWriter(fileName))
            {
                ...
                writer.PushCol(nameof(Header.collisionEffectsPlacementCount));
                writer.PushCol(nameof(Header.collisionEffectsPlacementAbsPtr));
                writer.PushCol(nameof(Header.boostPadEnable));
                writer.PushCol(nameof(Header.unk_0x1C_AbsPtr));
                writer.PushCol(nameof(Header.unk_0x20_AbsPtr));
                writer.PushCol(nameof(Header.unk_0x24_AbsPtr));
                ...
                writer.PushCol(nameof(Header.unk_0x5C_Count));
                writer.PushCol(nameof(Header.unk_0x60_AbsPtr));
                writer.PushCol(nameof(Header.collisionObjectsMeshCount));
                writer.PushCol(nameof(Header.collisionObjectsMeshAbsPtr));
                writer.PushCol(nameof(Header.unk_0x6C_Count));
                writer.PushCol(nameof(Header.unk_0x70_AbsPtr));
                writer.PushCol(nameof(Header.zero_0x74));
                writer.PushCol(nameof(Header.zero_0x78));
                writer.PushCol(nameof(Header.circuitType));
                writer.PushCol(nameof(Header.unk_0x80_AbsPtr));
                writer.PushCol(nameof(Header.unk_0x84_AbsPtr));
                writer.PushCol(nameof(Header.zero_0x88));
                writer.PushCol(nameof(Header.zero_0x8C));
                writer.PushCol(nameof(Header.trackInfoAbsPtr));
                writer.PushCol(nameof(Header.unk_0x94_Count));
                writer.PushCol(nameof(Header.unk_0x98_AbsPtr));
                writer.PushCol(nameof(Header.unk_0x9C_Count));
                writer.PushCol(nameof(Header.unk_0xA0_AbsPtr));
                writer.PushCol(nameof(Header.pathObjectsCount));
                writer.PushCol(nameof(Header.pathObjectsAbsPtr));
                writer.PushCol(nameof(Header.arcadeCheckpointCount));
                writer.PushCol(nameof(Header.arcadeCheckpointAbsPtr));
                writer.PushCol(nameof(Header.storyModeSpecialObjectsCount));
                writer.PushCol(nameof(Header.storyModeSpecialObjectsAbsPtr));
                writer.PushCol(nameof(Header.trackNodeTableAbsPtr));
                ...
                foreach (var file in coliSobjs)
                {
                    ...
                    writer.PushCol($"0x{coliHeader.trackNodeAbsPtr:X8}");
                    writer.PushCol(coliHeader.collisionEffectsPlacementCount);
                    writer.PushCol($"0x{coliHeader.collisionEffectsPlacementAbsPtr:X8}");
                    writer.PushCol(coliHeader.boostPadEnable);
                    writer.PushCol($"0x{coliHeader.unk_0x1C_AbsPtr:X8}");
                    writer.PushCol($"0x{coliHeader.unk_0x20_AbsPtr:X8}");
                    writer.PushCol($"0x{coliHeader.unk_0x24_AbsPtr:X8}");
                    ...
                    writer.PushCol($"0x{coliHeader.gameObjectAbsPtr:X8}");
                    writer.PushCol(coliHeader.unk_0x58);
                    writer.PushCol(coliHeader.unk_0x5C_Count);
                    writer.PushCol($"0x{coliHeader.unk_0x60_AbsPtr:X8}");
                    writer.PushCol(coliHeader.collisionObjectsMeshCount);
                    writer.PushCol($"0x{coliHeader.collisionObjectsMeshAbsPtr:X8}");
                    writer.PushCol(coliHeader.unk_0x6C_Count);
                    writer.PushCol($"0x{coliHeader.unk_0x70_AbsPtr:X8}");
                    writer.PushCol(coliHeader.zero_0x74); // 0
                    writer.PushCol(coliHeader.zero_0x78); // 0
                    writer.PushCol(coliHeader.circuitType);
                    writer.PushCol($"0x{coliHeader.unk_0x80_AbsPtr:X8}");
                    writer.PushCol($"0x{coliHeader.unk_0x84_AbsPtr:X8}");
                    writer.PushCol(coliHeader.zero_0x88); // 0
                    writer.PushCol(coliHeader.zero_0x8C); // 0
                    writer.PushCol($"0x{coliHeader.trackInfoAbsPtr:X8}");
                    writer.PushCol(coliHeader.unk_0x94_Count);
                    writer.PushCol($"0x{coliHeader.unk_0x98_AbsPtr:X8}");
                    writer.PushCol(coliHeader.unk_0x9C_Count);
                    writer.PushCol($"0x{coliHeader.unk_0xA0_AbsPtr:X8}");
                    writer.PushCol(coliHeader.pathObjectsCount);
                    writer.PushCol($"0x{coliHeader.pathObjectsAbsPtr:X8}");
                    writer.PushCol(coliHeader.arcadeCheckpointCount);
                    writer.PushCol($"0x{coliHeader.arcadeCheckpointAbsPtr:X8}");
                    writer.PushCol(coliHeader.storyModeSpecialObjectsCount);
                    writer.PushCol($"0x{coliHeader.storyModeSpecialObjectsAbsPtr:X8}");
                    writer.PushCol($"0x{coliHeader.trackNodeTableAbsPtr:X8}");
