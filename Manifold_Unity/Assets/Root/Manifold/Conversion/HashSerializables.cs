...
namespace Manifold.Conversion
{
    public static class HashSerializables
    {
        ...
        /// <summary>
        /// Readonly table MD5 hashes for each stage (decompressed) in GFZJ01
        /// </summary>
        public static readonly Dictionary<int, string> ColiCourseMD5NtscJ = new Dictionary<int, string>()
        {
