...
namespace GameCube.GFZ
{
    ...
    public enum CourseIndexAX
    {
        ...
        [Description("Surface Slide (test)")]
        TestSurfaceSlide = 72,
        [Description("Loop Cross (test)")]
        TestLoopCross = 77,
        ...
        TestStory2 = 91,
        [Description("Story 3 (test)")]
        TestStory3 = 92,
        [Description("Story 4 (test)")]
        TestStory4 = 93,
        [Description("Story 5 (test)")]
        TestStory5 = 94,
        [Description("Story 6 (test)")]
        TestStory6 = 95,
        [Description("Story 7 (test)")]
        TestStory7 = 96,
        [Description("Story 8 (test)")]
        TestStory8 = 97,
        ...
        TestTwistRoad = 102,
        [Description("Multiplex (test)")]
        TestMultiplex = 103,
        [Description("Intersection (test)")]
        TestIntersection = 104,
        [Description("Undulation (test)")]
        TestUndulation = 105,
        [Description("Drift Highway (test)")]
        TestDriftHighway = 107,
        [Description("Aero Dive (test)")]
        TestAeroDive = 108,
        [Description("Lateral Shift (test)")]
        TestLateralShift = 110,
    }
}