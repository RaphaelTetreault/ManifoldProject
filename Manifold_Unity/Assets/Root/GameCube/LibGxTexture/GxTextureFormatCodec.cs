...
namespace GameCube.LibGxTexture
{
    ...
    /// <summary>
    /// Base class to be implemented by all texture formats supported by GxTexture.
    /// </summary>
    public abstract class GxTextureFormatCodec
    {
            ...
            byte[] src, int srcPos, byte[] srcPal, int srcPalPos)
        {
            ...
            // Get the properties of each tile of the image
